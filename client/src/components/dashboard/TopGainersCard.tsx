...
export default function TopGainersCard() {
  ...
  return (
    <Link to="/gainers" className="block h-full">
      <Card className="dashboard-card neon-hover bg-gradient-to-br from-green-500/10 to-green-500/20 h-auto sm:h-full min-h-[260px] cursor-pointer" style={{ "--neon-glow": "hsl(120, 100%, 40%)" } as React.CSSProperties}>
